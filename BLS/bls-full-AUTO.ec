...
adversary Adv (adv_public_key : (G_1, int) ) : (message * G_1) {message -> G_1; (message) -> G_1; (message) -> G_1; (message) -> G_1; () -> int; () -> int}.
...
game blsfull_EF = {
  ...
  abs A = Adv{Hash, Sign, testFunction, testFunction2, testFunction5, testFunction4}
